module.exports = function(grunt) {
    ...
    grunt.option('solutionName','MF.DomainService');
    grunt.option('projectName','MF.DomainService');
    ...
    grunt.option('deployFolder','/ConsoleApps/MF.DomainService'+grunt.option('target'));
...
// tasks
        ...
        hbsconfigpoke:{
            compile:{
                ...
                files:{
                    'build_artifacts/MF.DomainService.exe.config' : grunt.option('srcFolder') + '/App.config.hbs'
                }
            }
        },
