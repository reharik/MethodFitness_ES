...
namespace MF.Core.Infrastructure.GES
{
    public class GetEventStoreRepository : IGetEventStoreRepository
    {
        ...
        public void Save(IAggregate aggregate, Guid commitId, string continuationId = null)
        {
            Save(aggregate, commitId, new Dictionary<string, object> {{"ContinuationId", continuationId}});
        }
