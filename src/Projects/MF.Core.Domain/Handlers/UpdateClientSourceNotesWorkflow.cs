...
{
    public class UpdateClientSourceNotesWorkflow : HandlerBase, IHandler
    {
        private readonly IGetEventStoreRepository _getEventStoreRepository;
        public UpdateClientSourceNotesWorkflow(IMongoRepository mongoRepository,
            ...
            : base(mongoRepository, uiResponsePoster, logger)
        {
            ...
            register(typeof(UpdateClientSourceNotes), updateClientSourceNotes);
        }

        private void updateClientSourceNotes(IGESEvent x)
        {
            var _vent = (UpdateClientSourceNotes)x;
